...
| Routev13 | per-level eval clips (gameplay/level_*), backward-chaining frontier 0.5/k16 for the route | running | replaces v12 (warp/1-2 stayed 0 for 2600 epochs; off-route exits 4%) |
