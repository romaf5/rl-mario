...
| Pos84rand | tuning 6: **explore_pure: true** (explore episodes = pure random, persistence 1..8) on the 32-px-cell config; fresh policy, archive seeded from Pos84y32 at 11:25 | running (started 2026-09-06 11:25, GPU1) | why: y32's predecessor pool put 1581 + 2496 restarts into the floor-with-revealed-block cells with 0 wins; the required jump is a short hop + nudge, absent from policy+8-step-macro noise. PREDICTION: 30 min (11:55) first wins from the floor-with-revealed-block cells; 2 h (13:25) chain into bins 14-17 and eval > 2600; 3 h (14:25) eval > 3100; 4 h (15:25) door-side victory |
| Pos84y32 | tuning 5: **cell_y_band: 32** on the predecessor-practice config; fresh policy, archive seeded from Pos84pred at 10:10 re-keyed at 32 px | running (started 2026-09-06 10:10, GPU0) | why: with 64-px bands 'on the block' (ypix 112) and 'on the pipe top' (64) were one cell -- two different jumps sharing one restart point and one failure weight. PREDICTION: 30 min (10:40) separate block-top and pipe-top cells both with wins; 2 h (12:10) wins from the floor-with-revealed-block cells; 3 h (13:10) eval > 3100; 4 h (14:10) door-side victory |
