...
| Pos84cells | tuning 2: **2D first-visit bonus** (+2 per new (frame, x/64, y/32) cell per life) on top of the practice-concentration config; from scratch, empty archive | running (started 2026-09-06 04:00) | why: both runs' archives show the missing link is bins 14-17 -> the block: a y change at the same x that x-progress never pays for; the bonus pays landing ON the block once per life, never negative, bounded. PREDICTION: 30 min (04:30) corridor; 2 h (06:00) winning cells in bins 14-17; 3 h (07:00) clean-eval mean > 3100; 4 h (08:00) door-side victory. Miss -> actors/threads |
