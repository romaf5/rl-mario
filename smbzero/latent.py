...
class LatentTree:
    ...
    def __init__(self, model, max_nodes=4096, c_puct=1.5, scale=32.0, fpu=0.5,
        ...
        # The world model's policy head was never trained (wmtrain has no policy loss), so the
        # search explored from random weights -- and the prior is what makes a search work: the
